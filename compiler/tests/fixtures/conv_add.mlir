"builtin.module"() ({
  "func.func"() <{function_type = (tensor<1x8x8x4xi8>, tensor<1x8x8x8xi8>) -> tensor<1x8x8x8xi8>, sym_name = "main"}> ({
  ^bb0(%arg0: tensor<1x8x8x4xi8>, %arg1: tensor<1x8x8x8xi8>):
    ...
    %11 = "tosa.const"() <{values = dense<31> : tensor<1xi8>}> : () -> tensor<1xi8>
    %12 = "tosa.rescale"(%10, %5, %11, %8, %8) <{input_unsigned = false, output_unsigned = false, per_channel = false, rounding_mode = #tosa.rounding_mode<SINGLE_ROUND>, scale32 = true}> : (tensor<1x8x8x8xi8>, tensor<1xi32>, tensor<1xi8>, tensor<1xi8>, tensor<1xi8>) -> tensor<1x8x8x8xi8>
    %13 = "tosa.rescale"(%arg1, %5, %11, %8, %8) <{input_unsigned = false, output_unsigned = false, per_channel = false, rounding_mode = #tosa.rounding_mode<SINGLE_ROUND>, scale32 = true}> : (tensor<1x8x8x8xi8>, tensor<1xi32>, tensor<1xi8>, tensor<1xi8>, tensor<1xi8>) -> tensor<1x8x8x8xi8>
    %14 = "tosa.add"(%12, %13) : (tensor<1x8x8x8xi8>, tensor<1x8x8x8xi8>) -> tensor<1x8x8x8xi8>
    "func.return"(%14) : (tensor<1x8x8x8xi8>) -> ()
  }) : () -> ()
}) : () -> ()
