...
-- modules/canny_nms/doc/canny_nms_req.md and
-- modules/canny_nms/doc/canny_nms_proposal.md.
entity canny_nms is
  port (
    clk   : in std_logic;
    rst_n : in std_logic;
...
architecture rtl of canny_nms is
  ...
  constant c_pipeline_width : positive := c_mag_width + 2;

  subtype magnitude_t is std_logic_vector(c_mag_width - 1 downto 0);
...
begin
  ...
  -- the externally visible tvalid with rst_n so the "output register"
  ...
  m_axis_tdata <= pipeline_output_data(c_pipeline_width - 1 downto 2);
