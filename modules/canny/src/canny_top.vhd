...
-- every submodule in this project -- see modules/canny/doc/canny_top_req.md
...
architecture a of canny_top is
  ...
  -- window-fill latency (W3's ~2*img_width+2 cycles, per
  -- modules/canny/doc/canny_top_req.md) without ever back-pressuring
  ...
  constant dir_fifo_depth : positive := next_pow2(2 * img_width + 16);

begin

  ------------------------------------------------------------------------------
  w1_inst : entity work.canny_window3x3
    generic map (
      img_width  => img_width,
  ...
  ------------------------------------------------------------------------------
  gaussian_inst : entity work.canny_gaussian3x3
    port map (
      clk => clk,
  ...
  ------------------------------------------------------------------------------
  w2_inst : entity work.canny_window3x3
    generic map (
      img_width  => img_width,
      img_height => img_height,
      data_width => 8,
  ...
  ------------------------------------------------------------------------------
  sobel_inst : entity work.canny_sobel3x3
    port map (
      clk   => clk,
      reset => reset,
  ...
  ------------------------------------------------------------------------------
  w3_inst : entity work.canny_window3x3
    generic map (
      img_width  => img_width,
      img_height => img_height,
      data_width => 11,
  ...
  ------------------------------------------------------------------------------
  nms_inst : entity work.canny_nms
    port map (
      clk   => clk,
      reset => reset,
  ...
  ------------------------------------------------------------------------------
  threshold_inst : entity work.canny_threshold
    generic map (
  ...
  ------------------------------------------------------------------------------
  w4_inst : entity work.canny_window3x3
    generic map (
      img_width  => img_width,
      img_height => img_height,
      data_width => 2,
  ...
  ------------------------------------------------------------------------------
  hysteresis_inst : entity work.canny_hysteresis
    port map (
      clk   => clk,
      reset => reset,
